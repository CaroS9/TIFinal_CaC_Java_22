...
<body>
  ...
  <script>// valido las entradas
        ...
        // Botón Resumen recibe un escuchador y la funcion del cálculo  onclick="this.innerHTML='Ooops!'"  onclick="changeText(this)"
